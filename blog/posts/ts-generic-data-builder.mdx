...
tags: ["typescript"]
summary: "Using a builder pattern to properly translate data between integration points when utilizing Typescript generic functions"
---
...
```ts fileName="order.ts" lines={["5:5", "15:19", "23:23"]}
import { z } from "zod";
...
```ts fileName="integration.ts" lines={["19:21", "27:30"]}
import { OrderEvent, OrderEventData } from "./order.ts";
