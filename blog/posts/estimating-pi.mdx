...
tags: ["python", "math"]
draft: false
summary: "Estimating Pi using a Python Monte Carlo simulation"
---
...
<Image alt="Concept" src="/assets/blog/images/estimating-pi/calculation-1.png" width={2214} height={1596} />

In order to truly calculate for the number Pi, you can rearrange the above calculation to look like:

<Image alt="Concept" src="/assets/blog/images/estimating-pi/calculation-2.png" width={2214} height={1596} />
...
<Image alt="Concept" src="/assets/blog/images/estimating-pi/first.png" width={2214} height={1596} />
...
<Image alt="Concept" src="/assets/blog/images/estimating-pi/second.png" width={2214} height={1596} />
...
<Image alt="Concept" src="/assets/blog/images/estimating-pi/final.png" width={2214} height={1596} />
