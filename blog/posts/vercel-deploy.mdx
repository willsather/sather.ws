...
draft: false
summary: "How to manually build and deploy a Next.js App Router application to Vercel using a GitHub Action pipeline."
---
...
```ymal fileName="deploy.yaml" showLineNumbers
