    ...
    <main className="min-h-screen px-6 py-12 text-neutral-100 md:px-24 md:py-16">
      <div className="max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="font-mono text-neutral-400 text-sm">all writing</p>
        </div>

        {/* Posts list */}
        <div className="space-y-6">
          {posts.map((post) => (
            <div key={post.slug} className="border-neutral-800 border-b pb-6">
              <div className="mb-2">
                {post.external ? (
                  <Link
                    href={post.external}
                    className="text-lg text-white transition-colors hover:text-neutral-300"
                    target="_blank"
              ...
              <p className="text-neutral-300 leading-relaxed">{post.summary}</p>
                ...
                <div className="mt-2">
                  <div className="flex flex-wrap gap-2">
                    {post.tags.map((tag) => (
                      <span
                        key={tag}
                        className="font-mono text-neutral-500 text-xs"
                      >
                        #{tag}
                      </span>
                    ))}
